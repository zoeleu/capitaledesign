      ...
      <div className="container">
        <div className="preview">
          <NeonText
            ...
            background={support === 'minimalist' ? 'transparent' : "white"}
            className='neon-text'
          />
        </div>
